...
@section('content')
	<div class="row mb-4 px-2">
		<a href="{{ route('config.breca_espectaculos.index') }}" class="col col-md-2 btn btn-sm grey darken-2 text-white mr-auto" style="border-radius: 16px;"><i class="fa fa-reply"></i> Regresar</a>
	</div>

    <div class="container-fluid mx-auto">
		<div class="card border" style="border-radius: 16px">
			<div class="card-body">
				<form action="{{ route('config.breca_espectaculos.breca_espectaculos_imagenes.store') }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="row">
						<div class="col-xl-6 col-lg-9 col-md-9 col-sm-12 col-xs-12 mx-auto form-group text-center">
                            ...
                            <input type="hidden" name="espectaculo" id="espectaculo" value="{{ $espectaculo }}" required/>
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-6 text-center">
					<div class="card border" style="border-radius: 16px;">
						<div class="card-body">
							<div class="row">
								<div class="col">
									<img src="{{ asset('img2/photos/breca_espectaculos/galeria/'.$g->foto) }}" alt="" class="img-fluid px-2" width="100%" height="100%">
								</div>
							</div>
						</div>
						<div class="card-footer">
							<div class="row">
								<div class="col">
									<form action="{{ route('config.breca_espectaculos.breca_espectaculos_imagenes.destroy', [$g->id]) }}" method="POST" style="display: inline;">						
										@csrf
										@method('DELETE') 
