            ...
            <div class="col">
                <div class="card">
                    <div class="card-body text-center">
                        <form action="{{ route('config.breca_espectaculos.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row mx-auto">
                                <div class="col-2"></div>
                                <div class="col-xl-6 col-lg-9 col-md-12 col-sm-12 col-xs-12 text-end">
                                    <div class="row">
                                        <div class="col">
                            ...
                            <input type="hidden" name="contacto" value="." class="">
                            {{--
                            <div class="row">
                                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 mx-auto text-center col-xs-12 mt-5">
                                    <div class="form-group row text-center"> 
